...
if __name__ == '__main__':
    ...
    db_test = SurfaceNormalsDataset(input_dir='/home/an/Desktop/cleargrasp/data/datasets/cup-with-waves-train/rgb-imgs',
                                    label_dir='/home/an/Desktop/cleargrasp/data/datasets/cup-with-waves-train/camera-normals',
                                    transform=augs,
    ...
    for i in range(5):
        image, mask, _ = dataset[np.random.choice(n)]
        ax[i, 0].imshow(np.transpose(image, (1, 2, 0)))
        ax[i, 1].imshow(np.transpose(mask, (1, 2, 0)))
