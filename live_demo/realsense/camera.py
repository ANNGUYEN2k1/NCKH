...
class Camera(object):
    ...
    def get_data(self):
        ...
        #     left and right color image, self.im_width x self.im_height x 3 uint8, number of bytes: self.im_width x self.im_height x 3 x 2
        data = b''
        while len(data) < ((9*4 + 9*4 + 16*4 + 4 + 8)+(self.im_height*self.im_width*6)):
        ...
        # TODO: Get depth scaled from data and use that here
