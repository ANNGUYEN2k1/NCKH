...
depth_file = '/home/an/Desktop/cleargrasp/data/cleargrasp-dataset-test-val/synthetic-val/cup-with-waves-val/depth-imgs-rectified/000000003-depth-rectified.exr'
rgb_file = '/home/an/Desktop/cleargrasp/data/cleargrasp-dataset-test-val/synthetic-val/cup-with-waves-val/rgb-imgs/000000003-rgb.jpg'
json_file = '/home/an/Desktop/cleargrasp/data/cleargrasp-dataset-test-val/synthetic-val/cup-with-waves-val/json-files/000000003-masks.json'
mask_file = '/home/an/Desktop/cleargrasp/data/cleargrasp-dataset-test-val/synthetic-val/cup-with-waves-val/segmentation-masks/000000003-segmentation-mask.png'
pt_file_orig = 'pt_orig.ply'
pt_file_rot = 'pt_rot.ply'

mask = imageio.imread(mask_file)
CLIPPING_HEIGHT = 0.04  # Meters
IMG_HEIGHT = np.size(mask,0)
IMG_WIDTH = np.size(mask,1)
...
fx = 1386/1920*IMG_WIDTH 
fy = 1386/1080*IMG_HEIGHT
cx = IMG_WIDTH/2
cy = IMG_HEIGHT/2
...
R = pcd.get_rotation_matrix_from_zyx(rot_euler_xyz)
pcd.rotate(R, center=(cx,cy,0))
